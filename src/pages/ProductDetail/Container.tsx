...
export const Container = () => {
  ...
  const { similarProducts, productDetail } = useSelector(
  ...
  useEffect(() => {
    setProductId(window.location.pathname.split("/").at(-1));
    dispatch(setProductDetail(productId));
    productDetail && dispatch(setSimilarProducts(productDetail));
